...
/**
 * Spring profiles under which a {@link Application} can be run. If no profiles are
 ...
 * PostgreSQL instance to be available. 
 *
 * Mutual exclusivity and implicit activation of profiles as described below is enforced
 * by {@link Application#setupProfiles(ConfigurableEnvironment)}.
 */
public final class OlzProfiles {
    /**
    ...
    /**
     * The default profile for any {@link Application}. Indicates that the
